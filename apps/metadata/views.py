...
def section(request, id, *args, **kwargs):
    return process_REST(request, id, handler=BaseHandler(SectionSerializer, Section), *args, **kwargs)
...
def section_list(request, *args, **kwargs):
    return process_REST(request, handler=BaseHandler(SectionListSerializer, Section), *args, **kwargs)
