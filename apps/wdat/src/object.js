 ...
 * Module obj.
 *
 * The module provides helper functions for objects.
 */
var obj; (function(obj) {
   ...
   */
  obj.getRecursive = function(object, prop, children) {
    var found = null;
    var stack = [];
    stack.push(object);
   ...
   */
  obj.setRecursive = function(object, prop, val, children) {
    var found = 0;
    var stack = [];
    stack.push(object);
   ...
   */
  obj.merge = function(from, to, override, blacklist) {
    if (from) {
      for ( var i in from) {
