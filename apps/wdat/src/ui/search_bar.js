...
(function () {
  ...
  function SearchBar(name, bus) {
    ...
    this.gobutton = new WDAT.ui.Button('Go', this.lBus, 'go', 'blue');
   ...
   *  jQuery Object
   */
  SearchBar.prototype.toJQ = function () {
   ...
   * Return value: none
   */
  SearchBar.prototype.toggleAdvanced = function (forceShow) {
   ...
   */
  SearchBar.prototype.buildSearchString = function () {
   ...
   */
  SearchBar.prototype.createAdvancedPanel = function () {
    var that = this
    ...
    datepicker = new WDAT.ui.DatePicker(datewidget);
